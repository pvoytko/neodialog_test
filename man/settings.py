...
ADMINS = (
    ('Pavel Voytko', 'pvoytko@gmail.com'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_DIR, 'database/sqlite3.db'),
    }
}

# Hosts/domain names that are valid for this site; required if DEBUG is False
# See https://docs.djangoproject.com/en/1.5/ref/settings/#allowed-hosts
ALLOWED_HOSTS = ['neodialog_test.land-page-service.ru']
...
SECRET_KEY = 'fky9ej=hs&quj1%s3vahpn5x%o(u1fl&+-*-njj%0vsne(_4#9'
